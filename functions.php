...
function rbh_wp_theme_setup() {
    ...
    register_nav_menus( array(
        'primary' => esc_html__( 'Primary Menu', 'rbh-wp' ),
    ) );
...
add_action( 'after_setup_theme', 'rbh_wp_theme_setup' );

/**
 * Enqueue scripts and styles.
 */
function rbh_wp_scripts_styles() {
    ...
    // Theme CSS
    wp_enqueue_style( 'rbh-wp-style', get_template_directory_uri() . '/dist/css/main.min.css', array(), '1.0.0', 'all');

    // Theme JS
    wp_enqueue_script('rbh-wp-main-js', get_template_directory_uri() . '/dist/js/main.min.js', array('jquery'), '1.0.0', true);
    wp_enqueue_script('rbh-smart-header-js', get_template_directory_uri() . '/dist/js/smart-header.min.js', array(), '1.0.0', true);
    ...
    // wp_enqueue_script( 'rbh-wp-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20201208', true );
}

add_action( 'wp_enqueue_scripts', 'rbh_wp_scripts_styles' );

function rbh_wp_admin_styles() {
    wp_enqueue_style('rbh-wp-admin-styles', get_template_directory_uri() . '/dist/css/admin-styles.min.css');
    wp_enqueue_media();
...
add_action('admin_enqueue_scripts', 'rbh_wp_admin_styles');
